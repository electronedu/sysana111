  ...
  return (
    <MaxWidthWrapper className="max-w-3xl mx-auto px-8 mb-40">
      <AnimationContainer delay={0.1} className="w-full">
        ...
        <p className="mt-4">
          Welcome to Sysana. These terms and conditions outline the rules and
          regulations for the use of Sysana&apos;s website and services.
        </p>

        <h2 className="text-xl font-medium mt-8">Acceptance of Terms</h2>

        <p className="mt-8 text-muted-foreground">
          By accessing and using Sysana, you accept and agree to be bound by
        ...
        <p className="mt-8 text-muted-foreground">
          Sysana reserves the right to modify these terms at any time. We will
        ...
        <p className="mt-8">
          To use Sysana, you must be at least 18 years old and capable of
        ...
        <div className="mt-8">
          You agree not to use Sysana for any unlawful or prohibited activities,
        ...
        <p className="mt-8 text-muted-foreground">
          Sysana provides a URL shortening service that allows you to create
        ...
        <p className="mt-8 text-muted-foreground">
          Sysana offers analytics for your shortened URLs. You agree to use this
        ...
        <p className="mt-8 text-muted-foreground">
          You retain ownership of any content you upload or create using Sysana.
          However, by uploading or creating content, you grant Sysana a
        ...
        <p className="mt-8 text-muted-foreground">
          ...
          Sysana does not endorse or assume any liability for user content.
        </p>
        ...
        <p className="mt-8 text-muted-foreground">
          Sysana reserves the right to suspend or terminate your account at any
        ...
        <p className="mt-8 text-muted-foreground">
          Sysana is provided on an &quot;as is&quot; and &quot;as
        ...
        <p className="mt-8 text-muted-foreground">
          In no event shall Sysana be liable for any indirect, incidental,
        ...
        <p className="mt-8 text-muted-foreground">
          ...
          please contact us at support@sysana.io.
        </p>

        <p className="mt-8 font-medium">
          By using Sysana, you acknowledge that you have read, understood, and
