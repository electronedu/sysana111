        ...
        <div className="flex flex-col items-center justify-center w-full text-center bg-gradient-to-t from-background">
          <AnimationContainer className="flex flex-col items-center justify-center w-full text-center">
            ...
            <p className="mb-12 text-lg tracking-tight text-muted-foreground md:text-xl text-balance">
              The personal AI that remembers previous conversations.
              <br className="hidden md:block" />
              Built for your exact personality and preferences.
            ...
            <div className="flex items-center justify-center whitespace-nowrap gap-4 z-50">
              ...
              <Button asChild variant="purple" className="w-32">
                <Link
                  href="/auth/sign-in"
                  className="flex items-center justify-center"
                >
        ...
        <AnimationContainer delay={0.1}>
          <div className="flex flex-col w-full items-center lg:items-center justify-center py-8">
            ...
            <p className="mt-4 text-center lg:text-center text-lg text-muted-foreground max-w-lg">
              Sysana is a powerful link management tool that helps you shorten,
      ...
      <MaxWidthWrapper className="py-10">
        <AnimationContainer delay={0.1}>
          <div className="flex flex-col items-center lg:items-center justify-center w-full py-8 max-w-xl mx-auto">
            ...
            <p className="mt-4 text-center lg:text-center text-lg text-muted-foreground max-w-lg">
              Get started with Sysana today and enjoy more features with our pro
              plans.
            </p>
          </div>
        </AnimationContainer>
      ...
      <MaxWidthWrapper className="py-10">
        <AnimationContainer delay={0.1}>
          <div className="flex flex-col items-center lg:items-center justify-center w-full py-8 max-w-xl mx-auto">
            ...
            <p className="mt-4 text-center lg:text-center text-lg text-muted-foreground max-w-lg">
              Here&apos;s what some of our users have to say about Sysana.
            </p>
          </div>
        </AnimationContainer>
